...
namespace BDP.DPAM.WR.Account {
    ...
    export class Form {
        ...
        static checkValidVATNumber(formContext: Xrm.FormContext) {
            ...
            let _VATNumber_attribute: Xrm.Page.StringAttribute = formContext.getAttribute<Xrm.Page.StringAttribute>("dpam_s_vatnumber");
            ...
            if (_VATNumber_attribute.getValue()) {
                ...
                let _country_attribute: Xrm.Page.LookupAttribute = formContext.getAttribute<Xrm.Page.LookupAttribute>("dpam_lk_country");
                ...
                if (_country_attribute.getValue() && _country_attribute.getValue()[0] && _country_attribute.getValue()[0].id) {
                    ...
                    Xrm.WebApi.retrieveRecord(_country_lookupvalue.entityType, _country_lookupvalue.id, `?$select=dpam_s_vatformat, dpam_s_vatformatexample`).then(
        ...
        static filterComplianceSegmentation(executionContext: Xrm.Events.EventContext) {
            ...
            let _dpam_lk_counterpartymifidcategory: Xrm.Page.LookupAttribute = formContext.getAttribute<Xrm.Page.LookupAttribute>("dpam_lk_counterpartymifidcategory");
        ...
        static filterBusinessSegmentation(executionContext: Xrm.Events.EventContext) {
            ...
            formContext.getControl<Xrm.Page.LookupControl>("dpam_lk_businesssegmentation").addCustomFilter(filter, "dpam_counterpartybusinesssegmentation");
        }
